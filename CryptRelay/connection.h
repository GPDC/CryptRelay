...
//		u_char ihl_and_ver;			// ihl is the size of this ipv4 structure / 4; ex:  sizeof(IPV4Header) >> 2;
//		u_char dscp_and_ecn;		// Differentiated Services Code Point. Only TCP can control the Explicit Congestion Notification
